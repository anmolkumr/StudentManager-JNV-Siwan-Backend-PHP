...
$pdf->Cell($width_cell[2],$height,$row['eng1'],1,0,'C',$fill);
$pdf->Cell($width_cell[3],$height,$row['hin1'],1,0,'C',$fill);
$pdf->Cell($width_cell[4],$height,$row['math1'],1,0,'C',$fill);
$pdf->Cell($width_cell[5],$height,$row['sci1'],1,0,'C',$fill);
$pdf->Cell($width_cell[6],$height,$row['sst1'],1,1,'C',$fill);
